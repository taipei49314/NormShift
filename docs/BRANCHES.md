...
```text
master
ΓööΓöÇΓöÇ M0 R5 trust core          ΓåÉ default product / audit subject for M0

expedition/real-standards-observatory
ΓööΓöÇΓöÇ τ£ƒσ»ªµ¿Öµ║ûΘüáσ╛ü              ΓåÉ first live-RFC/W3C vertical slice

expedition/corpus-foundry-24h
ΓööΓöÇΓöÇ µ£Çµû░τáöτ⌐╢σ₧ï showcase       ΓåÉ campaign / capsules / review foundry
```
...
|--------|------------------------|------|
| `master` | ΓÇö | Frozen M0 trust core (R5). External M0 audit subject. |
