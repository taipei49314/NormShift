...
- Integrity: `sha256` `0334d0fabc384c51d11b397c025cad84812220683094293c406f81f64f48aa3a`

## Documents

| Side | Path | Version | SHA-256 | Bytes |
|------|------|---------|---------|-------|
| old | `fixtures/corpus/w3c/sample-v1.html` | `WD-excerpt-1` | `7ddf62a67fa7086e06338ee02c87241ade81feeccf1878144f151850a05580da` | 1202 |
| new | `fixtures/corpus/w3c/sample-v2.html` | `WD-excerpt-2` | `da83242c7bf6a6258c8160755e207b0420feb85526d18c3a8693e25cf3c945db` | 1307 |

### Provenance

- **old**: family=`w3c` adapter=`normshift.adapters.w3c`@1.0.0 type=`text/html`
  - canonical: `https://www.w3.org/TR/sample-api/`
  - etag: `W/"w3c-sample-v1"`
  - local_path (portable): `fixtures/corpus/w3c/sample-v1.html`
- **new**: family=`w3c` adapter=`normshift.adapters.w3c`@1.0.0 type=`text/html`
  - canonical: `https://www.w3.org/TR/sample-api/`
  - etag: `W/"w3c-sample-v2"`
  - local_path (portable): `fixtures/corpus/w3c/sample-v2.html`
