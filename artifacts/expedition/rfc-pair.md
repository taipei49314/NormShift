...
- Integrity: `sha256` `311d6cd101c2d3bc78c4d597f4d0959e474878d29c0b89cca2b03b1c84d49eec`

## Documents

| Side | Path | Version | SHA-256 | Bytes |
|------|------|---------|---------|-------|
| old | `fixtures/corpus/rfc/sample-v1.html` | `RFC9000-excerpt-1` | `ce963be51d85848e4b405d887ebbd35828251766c20807082f534eb052307f0f` | 1163 |
| new | `fixtures/corpus/rfc/sample-v2.html` | `RFC9000-excerpt-2` | `73b2aa2b39edd7b509823a90c161efbc961b8493328294ca223ab2f9ba906db9` | 1236 |

### Provenance

- **old**: family=`rfc` adapter=`normshift.adapters.rfc`@1.0.0 type=`text/html`
  - canonical: `https://www.rfc-editor.org/rfc/rfc9000.html`
  - etag: `W/"rfc9000-excerpt-v1"`
  - local_path (portable): `fixtures/corpus/rfc/sample-v1.html`
- **new**: family=`rfc` adapter=`normshift.adapters.rfc`@1.0.0 type=`text/html`
  - canonical: `https://www.rfc-editor.org/rfc/rfc9000.html`
  - etag: `W/"rfc9000-excerpt-v2"`
  - local_path (portable): `fixtures/corpus/rfc/sample-v2.html`
