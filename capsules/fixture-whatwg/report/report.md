...
- Integrity: `sha256` `44dcf03fefef0e9e5bfcfb9bd92580bb3c5c1f49dfadda6fb5e7931ee5d127f1`

## Documents

| Side | Path | Version | SHA-256 | Bytes |
|------|------|---------|---------|-------|
| old | `fixture-whatwg-v1.html` | `LS-excerpt-1` | `cfa04c916868abea8ffc72d7b17cb8f843928b1fb4e8e938d35847a724979297` | 889 |
| new | `fixture-whatwg-v2.html` | `LS-excerpt-2` | `85b1dc30504d8676fd9455d4f747283e41c9a6c91c19f4544464bd5834aa0c7f` | 970 |

### Provenance

- **old**: family=`whatwg` adapter=`normshift.adapters.whatwg`@1.0.0 type=`text/html`
  - local_path (portable): `fixture-whatwg-v1.html`
- **new**: family=`whatwg` adapter=`normshift.adapters.whatwg`@1.0.0 type=`text/html`
  - local_path (portable): `fixture-whatwg-v2.html`
